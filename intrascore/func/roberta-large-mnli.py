...
# print(model.config.id2label) # {0: 'CONTRADICTION', 1: 'NEUTRAL', 2: 'ENTAILMENT'}
        ...
        if last_embeddings is None: # None cannot be subscriptable
            ...
            for i in range(1, len(generated_texts)):
                ...
                for c in clusters:
                    ...
                    encoded_input = tokenizer(qa_1, qa_2, return_tensors = "pt", padding = "max_length", truncation = True, max_length = 512).to(device) # 클래스 로짓을 pytorch 텐서로 반환
